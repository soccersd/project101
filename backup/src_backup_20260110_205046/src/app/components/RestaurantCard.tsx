        ...
        >
            ...
            <div className="p-5 lg:p-6 flex flex-col flex-grow relative bg-white">
                ...
                <div className="pt-4 border-t border-zinc-100 flex items-center justify-between">
                    <span className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest transition-all duration-300 group-hover:text-zinc-600 group-hover:tracking-[0.2em]">
                        Explore
                    </span>

                    {/* Arrow Button - Pure CSS animation */}
                    <button className="w-10 h-10 rounded-full border border-zinc-200 flex items-center justify-center text-zinc-400 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-orange-500 group-hover:to-amber-500 group-hover:text-white group-hover:border-transparent group-hover:shadow-lg group-hover:shadow-orange-200">
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 24 24"
