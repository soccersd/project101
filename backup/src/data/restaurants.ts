export const restaurants = [
    ...
    {
        name: "ก๋วยเตี๋ยวหมูตุ๋น สูตรพริกคั่วคุณลุง",
        description: "หมูตุ๋นเปื่อยนุ่ม น้ำซุปเข้มข้น ทีเด็ดอยู่ที่พริกคั่วหอมๆ รสชาติกลมกล่อม",
        location: "หลัง มจพ.",
        price: "$",
        cuisine: "สตรีทฟู้ด",
        status: "ขายดี",
        image: "https://images.unsplash.com/photo-1594911776518-ff352c3c97d6?q=80&w=800&auto=format&fit=crop"
    },
    {
        name: "สยามหมูกระทะ",
